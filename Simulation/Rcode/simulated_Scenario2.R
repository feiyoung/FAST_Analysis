...
### Scenario 2 (batch effect=low, biological effect= low)
rm(list=ls())
load("./Simulation/simulated_datasets/batch_facScale0.2_de_prop0.15_seulist.rds")
...
#[1] 0.6494855 0.6188665 0.6308184
...
# [1] 0.9137586 0.9163747 0.9396894
...
## [1] 0.04250107 0.04678749 0.03848112
### multibatchPCA
require(batchelor)
tic_bPCA <- proc.time()
...
## [1] 0.04296301 0.04675539 0.03935431
